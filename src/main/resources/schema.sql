...
CREATE TABLE users (
    ...
    totp_enabled TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否启用2FA',
...
-- 初始化示例客户端（密钥：secret123）
INSERT INTO oauth_clients (client_id, client_secret, client_name, grant_types, redirect_uris, 
    scopes, client_type, description, enabled) VALUES
('web-portal', '$2a$10$xQsUvGHPcFpkkPd2xFEYo.R92eGQRBKp8TTEMzQRxKfvKVfMaK1Jm', 
    'Web门户应用', 'authorization_code,refresh_token', 
    'http://localhost:3000/callback,https://portal.example.com/callback',
    'openid,profile,email', 1, 'Web门户前端应用', 1),
    
('mobile-app', '$2a$10$xQsUvGHPcFpkkPd2xFEYo.R92eGQRBKp8TTEMzQRxKfvKVfMaK1Jm',
    '移动应用', 'authorization_code,refresh_token',
    'myapp://callback',
    'openid,profile', 2, 'iOS和Android移动应用', 1),
    
('spa-app', '$2a$10$xQsUvGHPcFpkkPd2xFEYo.R92eGQRBKp8TTEMzQRxKfvKVfMaK1Jm',
    '单页应用', 'authorization_code',
    'http://localhost:8080/callback',
    'openid,profile,email', 3, 'Vue/React单页应用', 1),
    
('backend-service', '$2a$10$xQsUvGHPcFpkkPd2xFEYo.R92eGQRBKp8TTEMzQRxKfvKVfMaK1Jm',
    '后端服务', 'client_credentials',
    NULL,
    'api.read,api.write', 4, '后端服务间调用', 1);
